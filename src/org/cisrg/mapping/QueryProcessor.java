        ...
        for (int c = 0; c < newNeighborNumA; c++) {
            ...
            if (mapped_atoms.get(c * 2).equals(indexJ)) {
                ...
                if (cTab1Copy.get(atomIndex * 4 + 3).compareToIgnoreCase("X") == 0) {
                    ...
                    McGregorChecks2.changeCharBonds(indexI, signs[counter], query.getBondCount(), query, cTab1Copy);

                    int cor_atom = searchCorrespondingAtom(newNeighborNumA, indexI, 1, mapped_atoms);
                    McGregorChecks2.changeCharBonds(cor_atom, signs[counter], target.getBondCount(), target, cTab2Copy);
                    counter++;
                } else {
                    step2(atomIndex);
                }
        ...
        for (int c = 0; c < newNeighborNumA; c++) {
            ...
            if (mapped_atoms.get(c * 2 + 0).equals(indexI)) {
                ...
                if (cTab1Copy.get(atomIndex * 4 + 2).compareToIgnoreCase("X") == 0) {
                    ...
                    McGregorChecks2.changeCharBonds(indexJ, signs[counter], query.getBondCount(), query, cTab1Copy);
    ...
    private boolean unMappedAtomsEqualsIndexJ(
        ...
        for (int c = 0; c < newNeighborNumA; c++) {
            ...
            if (new_Mapping.get(c * 2 + 0).equals(indexJ)) {
                ...
                if (cTab1Copy.get(atomIndex * 4 + 3).compareToIgnoreCase("X") == 0) {
                    step1(atomIndex, counter);
                    McGregorChecks2.changeCharBonds(indexI, signs[counter], setNumA, i_bond_setA, cTab1Copy);
                    int cor_atom = McGregorChecks2.searchCorrespondingAtom(newNeighborNumA, indexI, 1, new_Mapping);
                    McGregorChecks2.changeCharBonds(cor_atom, signs[counter], setNumB, i_bond_setB, cTab2Copy);
                    counter++;
    ...
    private boolean unMappedAtomsEqualsIndexI(
        ...
        for (int c = 0; c < newNeighborNumA; c++) {
            ...
            if (new_Mapping.get(c * 2 + 0).equals(indexI)) {
                ...
                if (cTab1Copy.get(atomIndex * 4 + 2).compareToIgnoreCase("X") == 0) {
                    step3(atomIndex, counter);
                    McGregorChecks2.changeCharBonds(indexJ, signs[counter], setNumA, i_bond_setA, cTab1Copy);
                    int cor_atom = McGregorChecks2.searchCorrespondingAtom(newNeighborNumA, indexJ, 1, new_Mapping);
                    McGregorChecks2.changeCharBonds(cor_atom, signs[counter], setNumB, i_bond_setB, cTab2Copy);
                    counter++;
                } else {
                    step4(atomIndex);
