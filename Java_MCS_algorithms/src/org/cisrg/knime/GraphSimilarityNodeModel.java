...
/*	public enum MappingAlgorithmName {
	...
	ExtendedAlgorithm mappingAlgorithmName = MappingAlgorithmNames[1];
    ...
    boolean detailedGhostInfo = false;
    int topologicalDistanceLimit = -1;
    boolean useRaymondHeuristics = false;
    boolean useRingHeuristics = false;
    int expansionTimeOut = 5000;
		...
		ExtendedCellFactory cf = new ExtendedCellFactory() {
			...
			*/
			...
			public DataCell[] getCells(final DataRow row) {
				...
				SimilarityComparator simHub = new SimilarityComparator( GraphSimilarityNodeModel.this, sComparator, mcsMapper, useWeights, ghostSubstructureInfo );
